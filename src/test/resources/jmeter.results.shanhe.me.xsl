                            ...
                            <div>
                                        ...
                                        <table>
                                            <xsl:for-each select="assertionResult">
                                                <tbody>
                                                    ...
                                                    <tr><td class="data key">Failure Message</td><td class="data delimiter">:</td><td class="data"><pre><xsl:value-of select="failureMessage"/></pre></td></tr>
                                                </tbody>
                                            </xsl:for-each>
                                        </table>
                                    </div>
                                ...
                                <div class="zebra">
                                    <table>
                                        ...
                                        <tr><td class="data key" style="word-wrap: break-word;">Response Data</td><td class="data delimiter">:</td><td class="data"><pre class="data"><xsl:value-of select="responseData"/></pre></td></tr>
